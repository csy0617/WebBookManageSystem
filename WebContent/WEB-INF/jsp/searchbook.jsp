	...
	<div class="container">
		<div class="row">
			<form class="form-horizontal"
				action="<%=application.getContextPath()%>/SearchServlet"
				method="post">
				<h3 style="text-align: center;">请输入需要查询的出版社关键字：</h3>
				<div class="form-group">
					<input type="text" class="form-control" style="width: 400px;" id="searchkey" name="searchkey" value="${pname}" />
					<input type="submit" class="form-control" value="搜索" style="width: 80px; margin-left: 420px; margin-top: -35px;" />
				</div>
			</form>
		</div>
	</div>
